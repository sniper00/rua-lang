...
use rua_ide::syntax::format::{check_format, format_str};
use rua_ide::syntax::{SyntaxKind, lex, parse_source_file};

const UPDATE_ENV: &str = "RUA_UPDATE_GOLDENS";
const UPDATE_COMMAND: &str = "RUA_UPDATE_GOLDENS=1 cargo test -p rua-ide --test \
