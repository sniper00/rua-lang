...
pub(super) enum BackgroundResult {
    ...
    WorkspaceScan {
        generation: u64,
        result: Option<Vec<crate::lsp::filesystem::WorkspaceScan>>,
    },
    LibraryScan {
        generation: u64,
        result: Box<Result<crate::lsp::filesystem::LibraryConfig, String>>,
    },
}
...
impl Server {
    pub(super) fn new(connection: Connection) -> Self {
        ...
        Self {
            ...
            standard_library_navigation_root: rua_common::materialized_embedded_std()
                .ok()
