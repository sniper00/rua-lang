...
pub struct ClosureParameterInfo {
    file_id: FileId,
    name: String,
    range: crate::analysis::TextRange,
    ty: String,
}
...
impl ClosureParameterInfo {
    ...
    pub fn range(&self) -> crate::analysis::TextRange {
        self.range
    }
            ...
            if let Expr::Closure { params, .. } = expr {
                for param in params {
                    ...
                    let range = source_map
                        ...
                        .unwrap_or_else(|| crate::analysis::TextRange::new(0, 0));
                    let ty = inference
...
fn text_range(range: rowan::TextRange) -> crate::analysis::TextRange {
    crate::analysis::TextRange::new(range.start().into(), range.end().into())
}
