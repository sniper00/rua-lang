...
use crate::analysis::vfs::FileId;

pub use crate::analysis::base::{FilePosition, FileRange, TextRange};
pub use crate::analysis::vfs::ProjectId;
...
pub struct CompletionItem {
    ...
    candidate_ty: Option<crate::analysis::hir::Ty>,
...
impl CompletionItem {
    ...
    pub fn with_candidate_ty(mut self, candidate_ty: crate::analysis::hir::Ty) -> Self {
    ...
    pub fn candidate_ty(&self) -> Option<&crate::analysis::hir::Ty> {
...
pub struct CallHierarchyItem {
    pub project_id: ProjectId,
    pub target: crate::analysis::hir::DefId,
    pub name: String,
    pub kind: crate::analysis::hir::DefKind,
    pub file_id: crate::analysis::vfs::FileId,
    pub range: TextRange,
