...
impl BaseDb {
    ...
    fn lower_body(
        &self,
        def_id: DefId,
        definition: &crate::analysis::hir::Definition,
...
fn syntax_range(node: &crate::syntax::SyntaxNode) -> crate::analysis::base::TextRange {
    let range = node.text_range();
    crate::analysis::base::TextRange::new(range.start().into(), range.end().into())
}
