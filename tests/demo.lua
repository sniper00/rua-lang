...
local Point, Marker, Container, Wrapper, Person, Counter, Color, Message, Option, Result, identity, label, first, demo_let, demo_control_flow, describe_color, classify_message, match_with_wildcard, demo_patterns, demo_closures, demo_expressions, demo_iterators, demo_extern, demo_literals, demo_comments, demo_self_receivers, greet_someone, demo_trait_object, main, math, utils
---@class Point
---@field x integer
---@field y integer
---@field label string
